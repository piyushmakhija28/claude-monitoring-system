...
def apply_patterns(topic):
    ...
    if not patterns:
        print(f"💡 No established patterns found for: {topic}")
    ...
    print(f"💡 Based on your past projects, here are relevant patterns:")
    print("=" * 70)
