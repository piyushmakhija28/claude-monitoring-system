...
# --- Class Diagram ---
S_CLASS_HDR   = ("swimlane;fontStyle=1;align=center;startSize=26;"
                 "container=1;collapsible=0;expand=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_CLASS_FILL, C_CLASS_STROKE))
S_IFACE_HDR   = ("swimlane;fontStyle=3;align=center;startSize=26;"   # italic+bold = interface
                 "container=1;collapsible=0;expand=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_IFACE_FILL, C_CLASS_STROKE))
S_ABST_HDR    = ("swimlane;fontStyle=2;align=center;startSize=26;"   # italic = abstract
                 "container=1;collapsible=0;expand=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_ABST_FILL, C_ABST_STROKE))
S_ENUM_HDR    = ("swimlane;fontStyle=1;align=center;startSize=26;"
                 "container=1;collapsible=0;expand=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_ENUM_FILL, C_ENUM_STROKE))
S_CLASS_ROW   = ("text;html=1;strokeColor=none;fillColor=none;"
...
# Relationship arrows
S_INHERIT     = ("endArrow=block;endFill=0;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_REALIZE     = ("endArrow=block;endFill=0;dashed=1;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_COMPOSE     = ("endArrow=diamond;endFill=1;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_AGGREGATE   = ("endArrow=diamond;endFill=0;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_ASSOCIATE   = ("endArrow=open;endSize=8;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_DEPEND      = ("endArrow=open;endSize=8;dashed=1;html=1;"
                 "strokeColor=%s;strokeWidth=1;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)

# --- Sequence Diagram ---
S_LIFELINE    = ("shape=mxgraph.uml.lifeline;align=center;startSize=40;"
                 "strokeColor=%s;strokeWidth=2;"
                 "fillColor=%s;html=1;resizable=0;" % (C_BLACK, C_WHITE))
S_ACTOR_LIFE  = ("shape=mxgraph.uml.actor;align=center;"
                 "strokeColor=%s;fillColor=%s;"
                 "html=1;verticalLabelPosition=bottom;verticalAlign=top;" % (C_BLACK, C_WHITE))
S_ACTIVATION  = ("html=1;strokeColor=%s;fillColor=%s;"
                 "strokeWidth=2;" % (C_BLACK, C_WHITE))
S_MSG_SYNC    = ("endArrow=block;endFill=1;html=1;"
                 "strokeColor=%s;strokeWidth=2;" % C_BLACK)
S_MSG_ASYNC   = ("endArrow=open;html=1;"
                 "strokeColor=%s;strokeWidth=2;" % C_BLACK)
S_MSG_RETURN  = ("dashed=1;endArrow=open;html=1;"
                 "strokeColor=%s;strokeWidth=1;" % C_BLACK)
S_FRAGMENT    = ("shape=umlFrame;html=1;strokeColor=%s;"
                 "strokeWidth=2;fillColor=none;whiteSpace=wrap;" % C_BLACK)

# --- Activity Diagram ---
S_ACT_INIT    = ("ellipse;html=1;"
                 "strokeColor=%s;fillColor=%s;" % (C_BLACK, C_BLACK))
S_ACT_FINAL   = ("shape=doubleEllipse;html=1;"
                 "strokeColor=%s;fillColor=%s;" % (C_BLACK, C_BLACK))
S_ACT_ACTION  = ("rounded=1;whiteSpace=wrap;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_ACT_FILL, C_CLASS_STROKE))
S_ACT_CALL    = ("rounded=1;whiteSpace=wrap;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;"
                 "shape=mxgraph.flowchart.start_2;" % (C_ACT_FILL, C_CLASS_STROKE))
S_ACT_DIAMOND = ("rhombus;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "fillColor=%s;perimeter=rhombusPerimeter;whiteSpace=wrap;" % (C_BLACK, C_WHITE))
S_ACT_FORK    = ("html=1;strokeColor=%s;strokeWidth=3;"
                 "fillColor=%s;" % (C_BLACK, C_BLACK))
S_ACT_ARROW   = ("endArrow=classic;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)

# --- State Diagram ---
S_ST_INIT     = ("ellipse;html=1;"
                 "strokeColor=%s;fillColor=%s;" % (C_BLACK, C_BLACK))
S_ST_FINAL    = ("shape=doubleEllipse;html=1;"
                 "strokeColor=%s;fillColor=%s;" % (C_BLACK, C_BLACK))
S_ST_BOX      = ("rounded=1;whiteSpace=wrap;html=1;"
                 "fillColor=%s;strokeColor=%s;"
                 "strokeWidth=2;arcSize=25;" % (C_STATE_FILL, C_STATE_STROKE))
S_ST_COMP     = ("swimlane;fontStyle=1;align=center;startSize=26;"
                 "rounded=1;arcSize=12;container=1;collapsible=0;expand=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_IFACE_FILL, C_CLASS_STROKE))
S_ST_CHOICE   = ("rhombus;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "fillColor=%s;perimeter=rhombusPerimeter;" % (C_BLACK, C_WHITE))
S_ST_ARROW    = ("endArrow=classic;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_ST_SELF     = ("endArrow=classic;html=1;"
                 "strokeColor=%s;strokeWidth=2;curved=1;" % C_BLACK)

# --- Component Diagram ---
S_COMP_BOX    = ("shape=mxgraph.uml.component;html=1;whiteSpace=wrap;"
                 "strokeColor=%s;fillColor=%s;"
                 "strokeWidth=2;" % (C_GRAY_STROKE, C_GRAY_FILL))
S_COMP_PROV   = ("ellipse;html=1;"
                 "strokeColor=%s;fillColor=%s;"
                 "strokeWidth=1;" % (C_BLACK, C_WHITE))
S_COMP_REQ    = ("ellipse;html=1;"
                 "strokeColor=%s;fillColor=none;"
                 "strokeWidth=2;" % (C_BLACK))
S_COMP_DEP    = ("endArrow=open;endSize=8;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_COMP_REAL   = ("endArrow=block;endFill=0;dashed=1;html=1;"
                 "strokeColor=%s;strokeWidth=1;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)

# --- Package Diagram ---
S_PKG_BOX     = ("shape=folder;html=1;whiteSpace=wrap;fontStyle=1;"
                 "tabWidth=42;tabHeight=14;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_ENUM_FILL, C_ENUM_STROKE))
S_PKG_IMPORT  = ("endArrow=open;endSize=8;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_PKG_ACCESS  = ("endArrow=open;endSize=8;dashed=1;html=1;"
                 "strokeColor=%s;strokeWidth=1;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)

# --- Deployment Diagram ---
S_DEP_NODE    = ("shape=cube;html=1;whiteSpace=wrap;fontStyle=1;"
                 "perimeter=cubePerimeter;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_NODE_FILL, C_NODE_STROKE))
S_DEP_DEVICE  = ("shape=cube;html=1;whiteSpace=wrap;"
                 "perimeter=cubePerimeter;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_BLUE_FILL, C_BLUE_STROKE))
S_DEP_ARTIFACT= ("shape=mxgraph.uml.artifact;html=1;whiteSpace=wrap;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=1;" % (C_WHITE, C_BLACK))
S_DEP_COMP    = ("rounded=0;whiteSpace=wrap;html=1;"
                 "fillColor=%s;strokeColor=%s;" % (C_BLUE_FILL, C_BLUE_STROKE))
S_DEP_CONN    = ("endArrow=open;endSize=8;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_DEP_ENV     = ("swimlane;fontStyle=1;align=center;startSize=24;"
                 "fillColor=none;strokeColor=%s;strokeWidth=2;html=1;" % C_BLACK)

# --- Use Case Diagram ---
S_UC_ACTOR    = ("shape=mxgraph.uml.actor;html=1;"
                 "fillColor=%s;strokeColor=%s;"
                 "verticalLabelPosition=bottom;verticalAlign=top;" % (C_WHITE, C_BLACK))
S_UC_CASE     = ("ellipse;html=1;whiteSpace=wrap;"
                 "fillColor=%s;strokeColor=%s;"
                 "strokeWidth=2;perimeter=ellipsePerimeter;" % (C_STATE_FILL, C_STATE_STROKE))
S_UC_SYSTEM   = ("rounded=0;html=1;fillColor=none;"
                 "strokeColor=%s;strokeWidth=2;"
                 "verticalAlign=top;fontStyle=1;" % C_BLACK)
S_UC_ASSOC    = "endArrow=none;html=1;strokeColor=%s;strokeWidth=1;" % C_BLACK
S_UC_INCL     = ("endArrow=open;endSize=8;dashed=1;html=1;"
                 "strokeColor=%s;strokeWidth=1;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
S_UC_EXTEND   = ("endArrow=open;endSize=8;dashed=1;html=1;"
                 "strokeColor=%s;strokeWidth=1;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)

# --- Object Diagram ---
S_OBJ_HDR     = ("swimlane;fontStyle=5;align=center;startSize=26;"  # 4+1=underline+bold
                 "container=1;collapsible=0;expand=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_BLUE_FILL, C_BLUE_STROKE))
S_OBJ_ROW     = ("text;html=1;strokeColor=none;fillColor=none;"
                 "align=left;verticalAlign=middle;spacingLeft=6;")
S_OBJ_DIV     = "line;html=1;strokeColor=%s;strokeWidth=1;fillColor=none;" % C_BLUE_STROKE
S_OBJ_LINK    = ("endArrow=none;html=1;"
                 "strokeColor=%s;strokeWidth=1;" % C_BLACK)

# --- Communication ---
S_COMM_OBJ    = ("swimlane;fontStyle=1;align=center;startSize=24;"
                 "container=0;collapsible=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_CLASS_FILL, C_CLASS_STROKE))
S_COMM_MSG    = ("endArrow=open;endSize=8;html=1;"
                 "strokeColor=%s;strokeWidth=2;" % C_BLACK)

# --- Composite Structure ---
S_CS_CLASS    = ("swimlane;fontStyle=1;align=center;startSize=26;"
                 "container=1;collapsible=0;expand=0;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_CLASS_FILL, C_CLASS_STROKE))
S_CS_PART     = ("rounded=0;whiteSpace=wrap;html=1;"
                 "fillColor=%s;strokeColor=%s;" % (C_ABST_FILL, C_ABST_STROKE))
S_CS_PORT     = ("html=1;strokeColor=%s;fillColor=%s;"
                 "strokeWidth=1;" % (C_BLACK, C_WHITE))
S_CS_CONN     = ("endArrow=none;html=1;"
                 "strokeColor=%s;strokeWidth=1;" % C_BLACK)

# --- Interaction Overview ---
S_IO_REF      = ("swimlane;fontStyle=1;startSize=20;html=1;"
                 "fillColor=%s;strokeColor=%s;strokeWidth=2;" % (C_ENUM_FILL, C_ENUM_STROKE))
S_IO_INIT     = ("ellipse;html=1;"
                 "strokeColor=%s;fillColor=%s;" % (C_BLACK, C_BLACK))
S_IO_FINAL    = ("shape=doubleEllipse;html=1;"
                 "strokeColor=%s;fillColor=%s;" % (C_BLACK, C_BLACK))
S_IO_DECISION = ("rhombus;html=1;strokeColor=%s;strokeWidth=2;"
                 "fillColor=%s;perimeter=rhombusPerimeter;whiteSpace=wrap;" % (C_BLACK, C_WHITE))
S_IO_ARROW    = ("endArrow=classic;html=1;"
                 "strokeColor=%s;strokeWidth=2;"
                 "edgeStyle=orthogonalEdgeStyle;" % C_BLACK)
...
def _vertex(cid, value, style, x, y, w, h, parent="1"):
    ...
    return (
        ...
        "    </mxCell>"
        % (cid, _esc(value), style, parent, x, y, w, h)
    )
...
def _edge(cid, value, style, src, tgt, parent="1"):
    ...
    return (
        ...
        "    </mxCell>"
        % (cid, _esc(value), style, src, tgt, parent)
    )
...
def _edge_points(cid, value, style, x1, y1, x2, y2, parent="1"):
    ...
    return (
        ...
        "      </mxGeometry>\n"
        "    </mxCell>"
        % (cid, _esc(value), style, parent, x1, y1, x2, y2)
    )
...
class DrawioConverter:
    ...
    def convert(self, diagram_type, analysis_data):
        ...
        try:
            ...
            cells = [
                _vertex(nid(), "Error: %s" % exc, S_ACT_ACTION, 100, 100, 400, 50)
            ]
    ...
    def _class_diagram(self, data, nid):
        ...
        for idx, cls in enumerate(classes[:40]):
            ...
            cells.append(
                _vertex_child(nid(), attr_text, S_CLASS_ROW,
                              0, HDR_H, BOX_W, attr_h, cid)
            )

            # Divider between attributes and methods
            cells.append(
                _vertex_child(nid(), "", S_CLASS_DIV,
                              0, HDR_H + attr_h, BOX_W, DIV_H, cid)
            )
            ...
            cells.append(
                _vertex_child(nid(), meth_text, S_CLASS_ROW,
                              0, HDR_H + attr_h + DIV_H, BOX_W, meth_h, cid)
            )
        ...
        if not cells:
            cells.append(_vertex(nid(), "No classes found",
                                 S_ACT_ACTION, 100, 100, 200, 50))
    ...
    def _sequence_diagram(self, data, nid):
        ...
        for i, p in enumerate(participants):
            ...
            cells.append(
                _vertex(lid, p, S_LIFELINE, px, MARGIN_Y, PART_W, LIFE_H)
            )
        ...
        for j, chain in enumerate(call_chains[:25]):
            ...
            if src_name == tgt_name:
                ...
                cells.append(
                    ...
                    "      </mxGeometry>\n"
                    "    </mxCell>"
                    % (cid, _esc(label), style,
                       sx, sy, sx, sy + 30,
                       sx + 80, sy, sx + 80, sy + 30)
                )
                continue
            ...
            tx = centers[tgt_idx]
            cells.append(
                _edge_points(nid(), label, style, sx, msg_y, tx, msg_y)
            )

        if not call_chains:
            # Show placeholder messages
            for j, (src, tgt, msg) in enumerate([
                (participants[0], participants[1], "request()") if len(participants) > 1 else (participants[0], participants[0], "self()"),
    ...
    def _activity_diagram(self, data, nid):
        ...
        for step in steps[:15]:
            ...
            if stype in ("decision", "condition", "check"):
                cid = nid()
                cells.append(
                    _vertex(cid, sname, S_ACT_DIAMOND,
                            CX - DW // 2, y, DW, DH)
                )
                ...
                yes_id = nid()
                cells.append(
                    _vertex(yes_id, "[yes] " + sname.split()[-1] + " ok",
                            S_ACT_ACTION, CX - AW // 2, yes_y, AW, AH)
                )
                ...
                fid = nid()
                cells.append(
                    _vertex(fid, "", S_ACT_FORK, CX - FW // 2, y, FW, FH)
                )
                ...
                cid = nid()
                cells.append(
                    _vertex(cid, sname, S_ACT_ACTION, CX - AW // 2, y, AW, AH)
                )
                cells.append(_edge(nid(), "", S_ACT_ARROW, prev_id, cid))
                node_ids.append(cid)
                prev_id = cid
        ...
        for idx, s in enumerate(states[:18]):
            ...
            if is_comp:
                ...
                for k, ss in enumerate(sub_states[:4]):
                    ...
                    cells.append(
                        _vertex_child(ss_id, ssname, S_ST_BOX,
                                      10, 36 + k * 52, SW - 20, 44, sid)
                    )
            else:
    ...
    def _component_diagram(self, data, nid):
        ...
        for i, comp in enumerate(components[:15]):
            ...
            for k, prov in enumerate(provides[:2]):
                pid = nid()
                cells.append(
                    _vertex(pid, prov, S_COMP_PROV,
                            x + CW + 5, y + 20 + k * 40, 20, 20)
                )
    ...
    def _package_diagram(self, data, nid):
        ...
        for i, pkg in enumerate(packages[:18]):
            ...
            label    = name + (("&#xa;" + "&#xa;".join(str(c) for c in contents[:4]))
                                if contents else "")
            col = i % MAX_COLS
            row = i // MAX_COLS
            x   = 40 + col * (PW + GAP_X)
    ...
    def _deployment_diagram(self, data, nid):
        ...
        if not nodes:
            nodes = [
                {"name": "Web Server",      "type": "server",
                 "artifacts": ["nginx:80", "Frontend App"]},
                {"name": "Application Server","type": "server",
                 "artifacts": ["Python API", "Worker Process"]},
                {"name": "Database Server",  "type": "database",
                 "artifacts": ["PostgreSQL:5432", "Redis:6379"]},
            ]
        ...
        for i, node in enumerate(nodes[:12]):
            ...
            for j, art in enumerate(artifacts[:6]):
                ...
                cells.append(
                    _vertex_child(nid(), str(art), S_DEP_COMP,
                                  10, art_y, NW - 20, ART_H, nid_)
                )
    ...
    def _usecase_diagram(self, data, nid):
        ...
        if not use_cases:
            use_cases = [
                "Login", "View Dashboard", "Create Record",
                "Edit Record", "Delete Record", "Generate Report",
        ...
        sys_id = nid()
        cells.append(_vertex(sys_id, system_name, S_UC_SYSTEM,
        ...
        for j, uc in enumerate(use_cases):
            ...
            uc_ids[ucname] = ucid
            cells.append(
                _vertex_child(ucid, ucname, S_UC_CASE,
                              ucx, ucy, UCW, UCH_UNIT, sys_id)
            )
    ...
    def _object_diagram(self, data, nid):
        ...
        if not objects:
            for cls in (data.get("classes") or [])[:4]:
                obj = {
                    ...
                    "class":   cls["name"],
                    "values":  {a["name"]: '"example"'
                                for a in cls.get("attributes", [])[:4]},
                }
                objects.append(obj)

        if not objects:
            objects = [
                {"name": "obj1", "class": "MyClass",
                 "values": {"id": "1", "name": '"test"', "active": "true"}},
                {"name": "obj2", "class": "MyClass",
                 "values": {"id": "2", "name": '"prod"',  "active": "false"}},
            ]
        ...
        for i, obj in enumerate(objects[:20]):
            ...
            cells.append(
                _vertex_child(nid(), "", S_OBJ_DIV, 0, HDR_H, OW, DIV_H, oid)
            )
            if values:
                val_lines = "&#xa;".join(
                    "%s = %s" % (k, v)
                ...
                cells.append(
                    _vertex_child(nid(), val_lines, S_OBJ_ROW,
                                  0, HDR_H + DIV_H, OW, val_h, oid)
                )
    ...
    def _communication_diagram(self, data, nid):
        ...
        for j, msg in enumerate(messages[:15]):
            ...
            if src_id and tgt_id:
                cells.append(
                    _edge(nid(), "%d: %s" % (j + 1, label),
                          S_COMM_MSG, src_id, tgt_id)
                )
    ...
    def _composite_diagram(self, data, nid):
        ...
        if not components:
            components = [
                {"name": "OrderService",
                 "parts": ["OrderValidator", "PriceCalculator"],
                 "ports": ["IOrderService"]},
                {"name": "PaymentService",
                 "parts": ["PaymentGateway", "FraudDetector"],
        ...
        for i, comp in enumerate(components[:8]):
            ...
            for k, part in enumerate(parts[:4]):
                ...
                py   = 36 + prow * (ph + 10)
                cells.append(
                    _vertex_child(nid(), str(part), S_CS_PART,
                                  px, py, pw, ph, cid)
                )
            ...
            for m, port in enumerate(ports[:3]):
                ...
                poy = 30 + m * 40
                cells.append(
                    _vertex_child(nid(), "", S_CS_PORT, pox, poy, 12, 12, cid)
                )
                # Port label
                cells.append(
                    _vertex(nid(), str(port), S_OBJ_ROW,
                             x - 80, y + 30 + m * 40, 75, 20)
                )
    ...
    def _interaction_diagram(self, data, nid):
        ...
        for step in steps[:15]:
            ...
            if stype in ("init", "start"):
                ...
                did = nid()
                cells.append(_vertex(did, sname, S_IO_DECISION,
                                     CX - DW // 2, y, DW, DH))
                if prev:
    ...
    def _generic_diagram(self, data, nid):
        ...
        for i, item in enumerate(items[:20]):
            cells.append(
                _vertex(nid(), item[:100], S_ACT_ACTION, 80, 80 + i * 70, 320, 50)
            )
        if not cells:
            cells.append(
                _vertex(nid(), "No data available", S_ACT_ACTION, 100, 100, 240, 50)
            )
        return cells
...
def get_shareable_url(xml_content, github_raw_url=None):
    ...
    if github_raw_url:
        import urllib.parse
        return "https://app.diagrams.net/?url=" + urllib.parse.quote(
            github_raw_url, safe=""
        )
