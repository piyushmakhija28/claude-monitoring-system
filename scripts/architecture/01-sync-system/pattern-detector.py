...
PATTERN_RULES: List[Dict[str, Any]] = [
    ...
    # ---------- Databases ----------
    {
        ...
        "category": "database",
        "marker_files": [],
        "keyword_hints": ["postgresql", "postgres", "psycopg2", "pg8000", "asyncpg",
                          "jdbc:postgresql", '"pg"', "Npgsql"],
        "search_in": [
            "requirements.txt", "requirements-dev.txt", "Pipfile", "pyproject.toml",
    ...
    },
    {
        ...
        "category": "database",
        "marker_files": [],
        "keyword_hints": ["mysqlclient", "PyMySQL", "mysql-connector", "jdbc:mysql",
    ...
    },
    {
        ...
        "category": "database",
        "marker_files": [],
        "keyword_hints": ["pymongo", "motor", "mongoose", "mongodb", '"mongodb"',
    ...
    # ---------- Auth ----------
    {
        ...
        "marker_files": [],
        "keyword_hints": [
            "jwt", "jsonwebtoken", "PyJWT", "python-jose", "flask-jwt",
    ...
    # ---------- DevOps ----------
    {
        "name": "docker",
        "category": "devops",
        "marker_files": ["Dockerfile", "docker-compose.yml", "docker-compose.yaml",
                         ".dockerignore"],
        "keyword_hints": [],
        "file_extensions": [],
    },
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Detect technology patterns from project files."
    )
    parser.add_argument(
        "project_root",
        nargs="?",
